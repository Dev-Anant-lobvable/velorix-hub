...
export const Globe = wrap(Iconsax.Global ?? Iconsax.Location);
...
export const Menu = wrap(Iconsax.HambergerMenu ?? Iconsax.Menu);
...
export const Users = wrap(Iconsax.Profile2User ?? Iconsax.User);
...
export const Zap = wrap(Iconsax.Flash ?? Iconsax.Activity);
